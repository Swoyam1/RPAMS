...
<div class="card bg-secondary text-white mb-4">
        <div class="card-body p-3"><h5 class="m-0">Add Green Zones</h5></div>
    </div>
<!-- -->
...
<div>
    <form id="nfz-add" action="admin/process/greenzone-add.php" method="POST">
    ...
    /*
        ...
        */
        ...
        permCircle = new google.maps.Circle({
            strokeColor: '#008000',//border color
            strokeOpacity: 0.5,//circle border
            strokeWeight: 1,//circle border width 
            fillColor: '#008000',
            fillOpacity: 0.3  ,
