...
<div class="card bg-secondary text-white mb-4">
        <div class="card-body p-3"><h5 class="m-0">Add Temporary No Fly Zones</h5></div>
    </div>
<!-- -->
...
<div>
    <form id="nfz-add" action="admin/process/tnfz-add.php" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input id="timestamp_from" name="timestamp_from" type="datetime-local" class="form-control" required value="100" />
            </div>

            <label class="col-sm-2 col-form-label">To</label>
            <div class="col-sm-4">
                <input id="timestamp_to" name="timestamp_to" type="datetime-local" class="form-control" required value="100" />
            </div>
        </div>
        <!-- Update -->
        <div class="form-group row">
